/**
 * @file Interface MessageControllerI for RESTful Web service API for likes resource
 */
 import {Request, Response} from "express";

 /**
  * @interface MessageControllerI defines RESTful Web service API for messages resource.
  */
