 ...
 */
  ...
  * <ul>
  *     <li>POST /users/:uid/bookmarks/:tid to bookmark a tuit with mentioned tid by a user with mentioned uid</li>
  *     <li>GET /users/:uid/bookmarks to retrieve an individual user's bookmarks </li>
  *     <li>DELETE /users/:uid/bookmarks/:tid to delete a bookmarked tuit with mentioned tid by user with mentioned uid</li>
  *     <li>GET /users/:uid/bookmarks/:tid to check if a particular tuit is bookmarked by the user</li>
 ...
 export default class BookmarkController implements BookmarkControllerI {
     ...
     public static getInstance = (app: Express): BookmarkController => {
         if (BookmarkController.bookmarkController === null) {
             ...
             app.get("/users/:uid/bookmarks/:tid", BookmarkController.bookmarkController.checkIfATuitIsBookmarkedByUser);
             app.delete("/users/:uid/bookmarks", BookmarkController.bookmarkController.deleteAllBookmarksForUser);
         }
